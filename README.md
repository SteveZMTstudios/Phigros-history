...
> [!CAUTION]
> 这个项目需要您的支持才能继续运作。如果项目无人支持，它将被迫在 2025-04-02 后停止更新，并在 **2026-02-19** 后无法提供下载。
> 
>，这个项目在过去几年一直尽力保持免费且高效的方式提供，我们已经花光了我们所有的预算。
>
> 由于所有的上游存储开始收取更加高昂的费用，此项目存储的费用和花销超出了我们所能承受的范围。
>
> （如果我们能收到大约80元的赞助，我们便可以支持这个项目继续运作大约1年。）
> 
