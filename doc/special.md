...
## 3.19.0(143)
这是鸽游在2026年愚人节发布的~~测测你的~~特别版本。

### 更新日志
```
Version 3.19.0 (143) 2026/04/01

1. 新增两首单曲：
•「After ZABANIYA (MUG Edit)」 by: Daily天利
2. 修复「ABYSS MOTION 192.333」 的预览图无法正确显示的问题

Version 3.19.0.1 (144) 2026/04/01

1. 新增一首单曲：
•「After ZABANIYA (MUG Edit)」 by: Daily天利
2. 修复「ABYSS MOTION 192.333」 的预览图无法正确显示的问题
3. 修复宣传横幅无法在规定时间显示的问题
4. 替换错误的图片与音源
```
...
> 进去之后选曲界面左下角有个测测你的phi人格，点进去随便选，瞎选都可以，最后会让你倒转屏幕或者按开始键，我试过，结果都一样，进了假谱后会让你选飞鸽传信或者漂流瓶，也是随便选，两个都行，但是选完了点我急没用，直接点好的，会闪退，再进去，再点测测你的phi人格，会显示有消息，两个随便选，就进去了 

>来自TapTap[ID:730988802 冰霜_Icefrost]

另：没有隐藏铺面，谁知道呢，反正4.1是愚人节

### [下载 3.19.0](https://stevezmt.top/Phigros-history/?vercode=143)
### [下载 3.19.0.1](https://stevezmt.top/Phigros-history/?vercode=144)
